...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/NszrvRrhb/model.json',modelLoaded);
...
function gotResult(error,results){
    if (error){
        ...
        console.log(results);
        document.getElementById("resultEmotionName").innerHTML[0].label;
        document.getElementById("resultEmotionName2").innerHTML[1].label;
